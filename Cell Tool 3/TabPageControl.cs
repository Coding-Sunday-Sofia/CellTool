...
class TabPageControl
{
    ...
    {
        if (TabCollections[i].Saved == true) {
            return true;
        }
        if (TabCollections[i].tifFI!= null && TabCollections[i].tifFI.available == false) {
            return false;
        }
