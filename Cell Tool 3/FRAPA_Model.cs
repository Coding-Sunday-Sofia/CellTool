        ...
        public static void FrappaNormalise(ResultsExtractor.MyForm form1)
        {
            ...
            foreach (TreeNode node in form1.dataTV.Store)
            {
                ...
                foreach (TreeNode n in node.Nodes)
                {
                    ...
                    {
                        lib.Add(names[0], new List<TreeNode>() {
                        n
                    });
                    }
                }
        ...
        */
        ...
        public class Frapa_DoubleRectangle
        {
            ...
            public static List<List<string>> ExportResults(MySolver.FitSettings curFit, string name)
            {
                ...
                List<string> constVals = new List<string>() {
                "", "Value_" + name, ""
            };
                List<string> XValsL = new List<string>() {
                "", "Xvals_" + name, ""
            };
                List<string> YValsL = new List<string>() {
                "", "Raw_" + name, ""
            };
                List<string> Fit1ValsL = new List<string>() {
                "", "Fit_FRAP_eq_" + name, ""
            };
                List<string> Fit2ValsL = new List<string>() {
                "", "Fit_Diffusion_eq_" + name, ""
            };
